...
//        animatorSet.setDuration(mFadeInOutMs);
    ...
    @SuppressLint("NewApi")
    private void start(View view,long duration,float fromScale,float toScale,float fromTranslationX,float fromTranslationY
    ...
    protected void onAttachedToWindow() {
        ...
        Log.e("antking_attached", "attached");
    }
    ...
    protected void onFinishInflate() {
        ...
        Log.e("antking_onfinishInflate", "onfinishinflate");
    }
